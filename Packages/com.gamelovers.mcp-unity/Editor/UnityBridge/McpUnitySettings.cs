...
namespace McpUnity.Unity
{
    ...
    public class McpUnitySettings
    {
        ...
        [Tooltip("Whether to switch to an available port when the configured port is already in use")]
        public bool AutoSelectAvailablePort = true;

        [Tooltip("Preferred port to reclaim when automatic port selection is enabled")]
        public int PreferredPort = 17806;

        [Tooltip("Number of ports to scan starting from the preferred port")]
        public int PortSearchRange = 30;
